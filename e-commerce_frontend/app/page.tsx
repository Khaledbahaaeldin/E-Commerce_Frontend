...
export default function Home() {
  ...
  const [categoriesRef, categoriesVisible] = useIntersectionObserver({ threshold: 0.1 });
  ...
  return (
    <div className={styles.homePage}>
      ...
      >
        <div className={styles.heroContent}>
          ...
          <div className={styles.heroCtas}>
            ...
            <Link href="/collections" className={styles.secondaryBtn}>Explore Collections</Link>
          </div>
        </div>
      ...
      <section 
        ref={featuredRef}
        className={`${styles.featuredSection} ${featuredVisible ? styles.visible : ''}`}
      >
      ...
      <section 
        ref={categoriesRef}
        className={`${styles.categoriesSection} ${categoriesVisible ? styles.visible : ''}`}
      >
          ...
          {categories.map((category, index) => (
            <div key={index} className={styles.categoryCard}>
              ...
              <div className={styles.categoryOverlay}>
                <h3>{category.name}</h3>
                <Link href={`/categories/${category.name.toLowerCase()}`} className={styles.categoryLink}>
                  Browse Products
      ...
      <section className={styles.collectionBanner} style={{
        backgroundColor: '#333',
        ...
        <div className={styles.collectionContent}>
          ...
          <h2>Summer 2025</h2>
          <p>Discover our latest collection featuring fresh styles for the season</p>
          <Link href="/collections/summer" className={styles.collectionBtn}>Explore Now</Link>
        </div>
      </section>
            ...
            <div key={testimonial.id} className={styles.testimonialCard}>
              <div className={styles.testimonialRating}>
                ...
                {[...Array(5 - testimonial.rating)].map((_, i) => (
                  <svg key={i + testimonial.rating} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                ))}
              </div>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerBottom}>
          ...
          <div className={styles.paymentIcons}>
            ...
            <svg width="36" height="24" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="24" rx="4" fill="#252525"/>
              <path d="M13.5 8H22.5C23.33 8 24 8.67 24 9.5V14.5C24 15.33 23.33 16 22.5 16H13.5C12.67 16 12 15.33 12 14.5V9.5C12 8.67 12.67 8 13.5 8Z" fill="#2196F3"/>
            </svg>
            <svg width="36" height="24" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="24" rx="4" fill="#252525"/>
